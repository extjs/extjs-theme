...
Another important sass file create is <code>my-theme/defines.sass</code>.  This file contains Sass variable declarations added to each Ext sass file.
...
Currently, the only effect available is <code>effects:modulate</code>, for modifying the _hue_, _saturation_ and _lightness of a theme according to RMagick[http://www.imagemagick.org/RMagick/doc/image2.html#modulate]:
